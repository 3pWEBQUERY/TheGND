...
async function getJob(id: string) {
  ...
  if (!res.ok) {
    // Try relative (works on server too if base is not set)
    const res2 = await fetch(`/api/jobs/${id}`, { cache: 'no-store' })
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[34vh] min-h-[280px]">
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-6">
          <div>
            <h1 className="text-4xl md:text-5xl font-thin tracking-wider text-white mb-2">JOB</h1>
