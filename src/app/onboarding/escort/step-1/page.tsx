...
type EscortStep1Form = z.infer<typeof escortOnboardingStep1Schema>
...
// Sprachen werden über LANGUAGES_DE bereitgestellt
...
export default function EscortOnboardingStep1() {
  ...
  const onSubmit = async (data: EscortStep1Form) => {
    ...
    try {
      const response = await fetch('/api/onboarding/escort/step-1', {
        method: 'POST',
        headers: {
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="text-sm font-light tracking-widest text-gray-600">
              ESCORT-EINRICHTUNG – SCHRITT 1/7
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="w-full max-w-2xl">
          ...
          <div className="text-center mb-16">
            <h1 className="text-5xl font-thin tracking-wider text-gray-800 mb-6">ESCORT-PROFIL</h1>
