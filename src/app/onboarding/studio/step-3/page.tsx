      ...
      <nav className="absolute top-0 w-full z-50 bg-transparent">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="text-sm font-light tracking-widest text-gray-600">STUDIO • Schritt 3/3</div>
          </div>
        </div>
      </nav>
        ...
        <div className="w-full max-w-2xl">
          ...
          <form onSubmit={onSubmit} className="space-y-6 border p-6 bg-gray-50">
            ...
            <div className="flex justify-between pt-4">
              <Link href="/onboarding/studio/step-2" className="text-sm font-light text-gray-600 hover:text-pink-500">Zurück</Link>
