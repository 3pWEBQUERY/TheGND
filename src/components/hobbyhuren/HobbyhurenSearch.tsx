...
export default function HobbyhurenSearch({ q, setQ, location, setLocation, onSubmit, loading, error, filters, onFiltersChange, verifiedOnly = false, setVerifiedOnly, ageVerifiedOnly = false, setAgeVerifiedOnly, hasVideoOnly = false, setHasVideoOnly, sort = 'newest', setSort }: Props) {
