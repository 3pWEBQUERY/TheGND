...
export default function JobsSearch({ q, setQ, category, setCategory, city, setCity, country, setCountry, onSubmit }: Props) {
  return (
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-8 gap-3 items-end">
            ...
            <div className="md:col-span-1">
              ...
              <Input value={country} onChange={(e) => setCountry(e.target.value)} placeholder="Land" className="rounded-none border-gray-300" />
            </div>
            <div className="md:col-span-1">
              <Button
                type="submit"
